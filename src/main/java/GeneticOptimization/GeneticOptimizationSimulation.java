...
public class GeneticOptimizationSimulation implements Serializable{
    ...
    private void addToComputedFitnessMap(ChromosomeFitness chromosomeFitness) {
        ...
        else
        {
            ...
            {//se è la prima volta che aggiorno il valore, calcolo qual è l'errore relativo tra la vecchia misura e quella nuova
    ...
    //accoppia tutti i chromosome in chromosomes non presenti in bestChromosomes e con probabilitÃ  pari a CROSSOVER_RATE effettua crossover
    ...
    //per ogni chromosome non presente in bestChromosomes per ogni gene effettua una mutazione con probabilitÃ  MUTATION_RATE
