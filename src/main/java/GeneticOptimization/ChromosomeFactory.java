...
class ChromosomeFactory {
    ...
    private static final Gene[] genes = {
            new IntegerGene("NUMBER_OF_AGENTS", 96 ,15, 100),
            new IntegerGene("INITIAL_STOCKS",37, 20, 200),
            new IntegerGene("INITIAL_CASH", 173337,10000, 200000),
            new IntegerGene("INITIAL_PRICE", 507 ,10, 1000),
            new FloatingPointGene("ALPHA_FRACTION_COEFF", 0.0342411, 0.0, 1.0),
            new FloatingPointGene("R_COEFF", 12.3,1.2, 16.0),
            new IntegerGene("M_COEFF", 3,2, 8),
            new FloatingPointGene("REMOVE_BUY_ORDERS",0.1665, 0.0, 0.5),
            ...
            new FloatingPointGene("LIMIT_BUY", 2.16,0.3, 3.0),
            new FloatingPointGene("LIMIT_SELL",2.68, 0.3, 3.0),
            new FloatingPointGene("IDLE", 0.111,0.0, 1.0),
